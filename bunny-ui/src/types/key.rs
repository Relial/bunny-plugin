...
impl From<Key> for egui::Key {
    fn from(value: Key) -> Self {
        match value {
            ...
            Key::Colon => Self::Colon,
            Key::Comma => Self::Comma,
            Key::Backslash => Self::Backslash,
            Key::Slash => Self::Slash,
            Key::Pipe => Self::Pipe,
            Key::Questionmark => Self::Questionmark,
            Key::Exclamationmark => Self::Exclamationmark,
            Key::OpenBracket => Self::OpenBracket,
            Key::CloseBracket => Self::CloseBracket,
            Key::OpenCurlyBracket => Self::OpenCurlyBracket,
            Key::CloseCurlyBracket => Self::CloseCurlyBracket,
